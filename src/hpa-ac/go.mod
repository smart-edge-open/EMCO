module github.com/open-ness/EMCO/src/hpa-ac

require (
	github.com/ghodss/yaml v1.0.0
	github.com/onsi/ginkgo v1.12.0
	github.com/onsi/gomega v1.9.0
	github.com/open-ness/EMCO/src/hpa-plc v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/open-ness/EMCO/src/hpa-plc => ../hpa-plc
