...
while [[ $# -gt 0 ]]; do
    ...
    case $arg in
        "--external" )
            ...
            base_url_clm=${base_url_clm:-"http://$master_ip:31856/v2"}
            base_url_ncm=${base_url_ncm:-"http://$master_ip:32737/v2"}
            base_url_orchestrator=${base_url_orchestrator:-"http://$master_ip:31298/v2"}
            base_url_ovnaction=${base_url_ovnaction:-"http://$master_ip:31181/v2"}
            base_url_dcm=${base_url_dcm:-"http://$master_ip:31877/v2"}
            #rsync_service_port=30441
            rsync_service_host="rsync"
            #ovnaction_service_port=30473
            ovnaction_service_host="ovnaction"
            shift
            ;;
        * )
            ARGS+=("$1")
...
base_url_ncm=${base_url_ncm:-"http://localhost:9081/v2"}
base_url_orchestrator=${base_url_orchestrator:-"http://localhost:9015/v2"}
base_url_ovnaction=${base_url_ovnaction:-"http://localhost:9051/v2"}
base_url_dcm=${base_url_dcm:-"http://localhost:9077/v2"}
rsync_service_port=${rsync_service_port:-9031}
rsync_service_host=${rsync_service_host:-"localhost"}
ovnaction_service_port=${ovnaction_service_port:-9032}
